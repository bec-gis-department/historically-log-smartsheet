...
def build_ss(ss_api):
    ...
    Created:
        03/08/2019 11:23AM
    Description:
        Builds the Client communication object for the BEC Bot Account Osmose System API Token
    ...
    logging.basicConfig(filename=r'sys_logs\bec_osmose_ss.log', level=logging.INFO)
    return ss_client
